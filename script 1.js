<script>
    ...
    function scrollToPlans() {
        console.log("scrollToPlans appelé");
        const plansSection = document.getElementById('plans');
        if (plansSection) {
            plansSection.scrollIntoView({ behavior: 'smooth' });
        } else {
            console.error("Section 'plans' non trouvée");
        }
    }
    ...
    function selectPlan(planType) {
        ...
        if (selectElement) {
            ...
            console.error("Élément 'subscriptionType' non trouvé");
        }
    }
    ...
    function showAdminLogin() {
        console.log("Accès administrateur demandé");
    ...
    function showAdminPanel() {
        console.log("Affichage du panneau administrateur");
    ...
    // Effacer les données
    function clearData() {
        console.log("Effacement des données demandé");
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log("DOM chargé, initialisation des étoiles");
        createStars();
    });
</script>
